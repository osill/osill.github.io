<?php
 ...
 { 
 	...
 	var $image_w=350;  //要显示图片的宽 
 	var $image_h=350;  //要显示图片的高 
 	var $upload_file_size; 
 	var $upload_must_size= 100000; //允许上传文件的大小，自己设置 
 	function upload_file() 
  	{ 
   		...
   		$this->file_type = array("image/jpg","image/jpeg","image/png","image/pjpeg","image/gif","image/bmp","image/x-png");  //允许上传文件的类型 
   		...
   		if(in_array($this->upload_filetype,$this->file_type)) 
   		{
    		...
    		{
     			$this->file_server_address = "../avatar/".$this->upload_server_name; 
